...
# ==================== الإعدادات الأساسية ====================
API_TOKEN = "7999963241:AAGNsR9SY9ZR6puBsg-Eq62NNOMSbTujKqA"
ADMIN_ID = 7947679527
DEVELOPER = "@ggzh9"
...
def handle_stars_payment(message):
    ...
    # تحديد نوع الاشتراك بناءً على المبلغ
    if amount >= 600:
        days = 30
        sub_type = "شهر"
    elif amount >= 50:
    ...
    # إشعار للمالك
    bot.send_message(ADMIN_ID, f"⭐ دفع نجوم\nالمستخدم: {user_id}\nالمبلغ: {amount} نجوم\nالباقة: {sub_type}")
